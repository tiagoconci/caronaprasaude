					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
									<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp;Edit Destino'), array('action' => 'edit', $destino['Destino']['id']), array('escape' => false)); ?> </li>
		<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete Destino'), array('action' => 'delete', $destino['Destino']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $destino['Destino']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Destinos'), array('action' => 'index'), array('escape' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Destino'), array('action' => 'add'), array('escape' => false)); ?> </li>
...
<div class="related row">
	...
	<thead>
	<tbody>
	<?php foreach ($destino['Parada'] as $parada): ?>
		<tr>
