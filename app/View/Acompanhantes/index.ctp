<div class="acompanhantes index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Acompanhantes'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Acompanhante'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('parada_id'); ?></th>
				...
				<?php foreach ($acompanhantes as $acompanhante): ?>
					<tr>
						<td><?php echo h($acompanhante['Acompanhante']['id']); ?>&nbsp;</td>
								<td>
			...
			<?php echo $this->Html->link($acompanhante['Paciente']['id'], array('controller' => 'pacientes', 'action' => 'view', $acompanhante['Paciente']['id'])); ?>
						...
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $acompanhante['Acompanhante']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $acompanhante['Acompanhante']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $acompanhante['Acompanhante']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $acompanhante['Acompanhante']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
